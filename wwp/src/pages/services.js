  ...
  return (
    <div className='total-services'>
      ...
      <form onSubmit={(event)=>{sub(event)}} id="survey-form">
            ...
            <div className="sub-category">
                <label id="contact-label" for="contact"></label>
                <input onChange={(e)=>{Setcontact(e.target.value)}} className="input-element" type='number' id="contact" placeholder="1234567890" required />
            </div>
